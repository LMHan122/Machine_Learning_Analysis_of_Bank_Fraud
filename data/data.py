...
#setting up logger
logging.basicConfig(level=logging.INFO, format="%(asctime)-20s %(message)s", filemode='w')
...
def data_download():
    ...
    downloaded_folder = os.path.join(destination_dir, '1')  # KaggleHub puts files in a folder labeled '1'
